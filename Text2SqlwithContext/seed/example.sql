...
(patient_id, metric_name, metric_value, unit, checkup_date, reference_range)
VALUES
-- 血糖记录（单位：mmol/L）
('P10001', '空腹血糖', 5.2, 'mmol/L', '2023-03-10', '3.9-6.1'),
('P10001', '空腹血糖', 6.1, 'mmol/L', '2023-06-15', '3.9-6.1'),
('P10001', '空腹血糖', 5.8, 'mmol/L', '2023-09-20', '3.9-6.1'),
('P10001', '空腹血糖', 7.0, 'mmol/L', '2024-01-05', '3.9-6.1'),  -- 异常值
('P10001', '空腹血糖', 6.3, 'mmol/L', '2024-04-12', '3.9-6.1'),

-- 血压记录（单位：mmHg）
('P10001', '收缩压', 118, 'mmHg', '2023-03-10', '90-140'),
('P10001', '收缩压', 125, 'mmHg', '2023-06-15', '90-140'),
('P10001', '收缩压', 132, 'mmHg', '2023-09-20', '90-140'),
('P10001', '收缩压', 148, 'mmHg', '2024-01-05', '90-140'),      -- 异常值
('P10001', '收缩压', 130, 'mmHg', '2024-04-12', '90-140');
